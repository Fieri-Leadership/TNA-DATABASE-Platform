...
def render_sidebar():
    try:
        ...
        logger.exception(f"Exception occurred while rendering the sidebar {repr(e)}.")
        st.exception(f"Something went wrong while rendering the side bar. Please contact your admin.")
...
def render_job_pages():
    try:
        ...
        logger.error(f"Something went wrong while loading jobs pages. Please contact the admin.{repr(e)}")
        st.error("Something went wrong loading this page. The error has been logged.")
...
def render_research_base():
    try:
        ...
        logger.error(f"Something went wrong while loading research base. Please contact the admin.{repr(e)}",exc_info=True)
        st.error("Something went wrong loading this page. The error has been logged.")
